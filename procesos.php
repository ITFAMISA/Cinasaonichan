...
$pageTitle = 'Gestión de Procesos de Producción';
...
<div class="filter-section">
    ...
    <div class="row g-3">
        <div class="col-md-4">
            ...
            <div class="relative">
                <input type="text" class="form-control pl-10" id="buscar" placeholder="Nombre o descripción del proceso...">
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        <span class="flex items-center">
            <i class="fas fa-cogs mr-2"></i> Gestión de Procesos de Producción
        </span>
        <div class="flex gap-2">
            ...
            <button class="btn btn-primary btn-sm group" id="btnNuevoProceso">
                <i class="fas fa-plus transition-transform group-hover:rotate-90"></i>
                <span class="ml-1">Nuevo Proceso</span>
            </button>
        </div>
    </div>
            ...
            <table class="table table-hover mb-0">
                <thead>
                    <tr>
                        ...
                        <th class="sortable" data-column="requiere_inspeccion_calidad">Requiere Inspección QC</th>
...
<script src="<?php echo BASE_PATH; ?>/app/assets/procesos.js?v=<?php echo time(); ?>"></script>
</body>
</html>
