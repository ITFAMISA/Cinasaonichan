...
$pageTitle = 'Gestión de Estaciones/Máquinas';
$model = new EstacionesModel($pdo);

// Obtener tipos de estaciones disponibles
$tipos = $model->obtenerTiposEstaciones();
...
<div class="filter-section">
    ...
    <div class="row g-3">
        <div class="col-md-4">
            ...
            <div class="relative">
                <input type="text" class="form-control pl-10" id="buscar" placeholder="Nombre o tipo de estación...">
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        <span class="flex items-center">
            <i class="fas fa-industry mr-2"></i> Gestión de Estaciones/Máquinas del Taller
        </span>
        <div class="flex gap-2">
            <button class="btn btn-info btn-sm group" id="btnDashboardTaller">
                <i class="fas fa-object-group transition-transform group-hover:scale-125"></i>
                <span class="ml-1">Dashboard Taller</span>
            </button>
            <button class="btn btn-primary btn-sm group" id="btnNuevaEstacion">
                <i class="fas fa-plus transition-transform group-hover:rotate-90"></i>
                <span class="ml-1">Nueva Estación</span>
            </button>
        </div>
    </div>
...
<script src="<?php echo BASE_PATH; ?>/app/assets/estaciones.js?v=<?php echo time(); ?>"></script>
</body>
</html>
